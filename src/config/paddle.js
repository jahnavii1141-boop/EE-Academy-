...
//   The full course  $79  one-time  → the whole 14-lesson system, tools, templates
//
// IMPORTANT: this is the *displayed* price. The amount actually charged comes
// from the Paddle price ID below (NEXT_PUBLIC_PADDLE_BASIC_PRICE_ID = the $79
...
export const PADDLE_CONFIG = {
  ...
  // The full course ($79) — env var name kept as _BASIC_ so the live price ID
