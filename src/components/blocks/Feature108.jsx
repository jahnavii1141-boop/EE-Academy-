...
const PILLARS = [
  {
    ...
    body: 'A 14-lesson path that turns a far-off deadline into this week\'s three tasks. The Research Question Checker stops you sinking weeks into a question that can\'t break a C. The EE Planner breaks the whole essay into weekly targets, so you always know your next move instead of drifting.',
    features: ['14-lesson curriculum', 'Research Question Checker', 'EE Planner (week-by-week)', 'Essay editor with autosave'],
  ...
  },
  {
    ...
    features: ['Criteria-by-criteria essay review', 'Supervisor Reply Drafter', '32/34 essay full breakdown'],
