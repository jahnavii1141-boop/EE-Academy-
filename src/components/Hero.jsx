    ...
    <section className="relative overflow-hidden min-h-[70vh] flex items-center">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-24 lg:py-32 w-full">
        <div className="max-w-2xl">
          ...
          <AnimateIn delay={0.1}>
            <h1 className="font-serif text-5xl lg:text-6xl xl:text-7xl font-bold text-cream leading-[1.05] mb-6">
              Master Your<br />
          ...
          <AnimateIn delay={0.2}>
            <p className="text-lg text-steel leading-relaxed max-w-lg mb-10">
