...
const CONTENT = [
  ...
  { type: 'step-process', steps: [
    ...
    { title: 'Phase 3 (Weeks 5-7): EE Dump and Research', text: 'This is the most important phase. Create your PROJECT A folder and EE Dump document. Research all 5 subtopics systematically: Google first, then Google Scholar. Track every source URL. By the end of this phase you should have enough material to write your entire essay from memory.' },
    { title: 'Phase 4 (Weeks 8-9): Structure and Outline', text: 'Use your Dump to create a detailed essay outline. Map each section to the IB criteria. Decide which analytical frameworks you\'ll use and where. Write your complete section-by-section plan before you write a single sentence of the essay.' },
  ...
  { type: 'comparison-table', headers: ['Week', 'Task', 'Output'], rows: [
    ...
    ['5', 'Create PROJECT A folder, EE Dump structure', 'Empty Dump template set up'],
    ['6-7', 'Full EE Dump — Google + Scholar', 'Dump complete, all URLs saved'],
    ['8', 'Structure and section outline', 'Section-by-section essay plan'],
    ['9', 'Analytical framework selection, outline review', 'Confirmed frameworks for each section'],
  ...
  { type: 'tip-box', text: 'The most important single rule in this timeline: complete your EE Dump before you start writing. Students who start writing before finishing research always end up stopping to search for sources mid-essay. That kills momentum and produces incoherent essays.' },
