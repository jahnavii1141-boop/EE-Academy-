...
const TIMELINE = [
  ...
  { label: 'The result', text: 'Predicted a C. Finished with an A and 32 out of 34. And I didn\'t even proofread.' },
  { label: 'The realisation', text: 'Once the EE was over, I almost sold my essay on Clastify for $7. Then I realised my essay itself wasn\'t the valuable part. The process behind it was. A student can read my essay and still have no idea how to build their own. But if I showed them exactly how I approached the research, structure, writing, and strategy, that would actually help.' },
  { label: 'The resource lab', text: 'So instead of selling fish for $7, I built a free resource lab that teaches you how to fish. This isn\'t a textbook written by a professor who hasn\'t been an IB student in 20 years. It\'s a system built by someone who was in your exact position recently enough to remember what actually helped and what was useless noise.' },
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <AnimateIn>
            <div className="text-center">
              ...
              <p className="text-ink-soft text-sm mt-3">Modules 1, 2, 3 & 5 are free — start immediately.</p>
            </div>
          </AnimateIn>
