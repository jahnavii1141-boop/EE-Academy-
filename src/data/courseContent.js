export const COURSE_MODULES = [
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: 'paragraph',
        text: 'Avoid the "In this essay, I will..." opening. It\'s passive, mechanical, and signals that you\'re writing an assignment, not research. Instead, begin with context, tension, or a specific example that naturally raises your research question.',
      },
      {
        type: 'heading',
      ...
      },
      {
        ...
        after: {
          ...
          text: '"While Smith (2020) demonstrated a correlation between social media use and political polarisation using survey data from 2,000 US adults, the study\'s reliance on self-reported usage patterns limits its applicability to behavioural analysis of actual voting decisions. This limitation motivates the present essay\'s use of engagement metric data rather than self-reported behaviour."',
        },
      },
      {
        type: 'heading',
      ...
      {
        type: 'warning-box',
        text: 'Only include tools you actually use in your analysis. If you promise a BCG Matrix in your methodology, the examiner expects to see it deployed in Section IV. Promise and not deliver = lost marks. This is one of the most common mistakes in EEs.',
      },
      {
        type: 'heading',
        text: 'The Analysis',
      ...
      {
        type: 'paragraph',
        text: 'Notice what the strong version does: it presents a specific data point, places it in context (industry average), draws an interpretive conclusion, and connects it to a broader argument. That\'s what analysis looks like.',
      },
      {
        type: 'heading',
        text: 'The Discussion',
      ...
      {
        type: 'paragraph',
        text: 'Evaluate your findings. What do they mean in context? How do they connect to your literature review? What are the strengths and limitations of your analysis? The best essays engage honestly with findings rather than cherry-picking evidence that supports a predetermined conclusion. Examiners reward intellectual honesty.',
      },
      {
        type: 'tip-box',
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        icon: 'Layout',
        title: 'Spacing',
        text: 'Double-spaced throughout. The only exceptions: block quotes (single-spaced) and bibliography entries (each entry single-spaced, but double-spaced between entries).',
      },
      {
        type: 'icon-card',
        icon: 'Clipboard',
      ...
      },
      {
        ...
        icon: 'BookOpen',
        title: 'Alignment',
        text: 'Left-aligned, not justified. Justified text creates uneven word spacing that makes dense academic text harder to read.',
      },
      {
        type: 'heading',
      ...
      {
        type: 'comparison-table',
        headers: ['Include on Title Page', 'Do NOT Include'],
        rows: [
      ...
      {
        type: 'paragraph',
        text: 'MLA is the most widely accepted citation format for IB EEs. Here are the rules you\'ll use most often:',
      },
      {
        type: 'numbered-steps',
        items: [
      ...
      {
        type: 'paragraph',
        text: 'Footnotes (technically Chicago style) are also accepted by the IB. They work particularly well for Business Management and Economics, where keeping the text clean while still showing sources is valuable. Number footnotes consecutively. Keep them brief.',
      },
      {
        type: 'heading',
      ...
      {
        type: 'warning-box',
        text: 'What counts as academic misconduct: copying from Clastify, having AI generate portions of your essay, paraphrasing too closely without attribution, fabricating data or sources, or submitting substantially co-written work. The consequences include diploma revocation. Don\'t risk it.',
      },
      {
        type: 'paragraph',
      ...
      {
        type: 'heading',
        text: 'The 15-Minute Pre-Submission Checklist',
      },
      {
        type: 'numbered-steps',
        items: [
          'Font is Times New Roman 12pt throughout (including headings)',
          'Essay is double-spaced throughout (check headers and footnotes too)',
          'Page numbers are in place, starting from the first content page',
          'Title page has all required elements and no identifying information',
          'Table of contents matches actual section headings and page numbers',
          'Headings are consistent in style and hierarchy throughout',
          'All in-text citations are correctly formatted and placed before the period',
          'Bibliography is complete, alphabetical, and uses consistent citation format',
          'Word count is under 4,000 (title page, bibliography, and appendices don\'t count)',
          'Final spell-check and proofread complete',
        ],
      },
      {
        type: 'tip-box',
        text: 'This checklist is probably the easiest mark boost you will ever get on any piece of work you submit in your life. Run it before you submit. Every time.',
      },
      {
        type: 'key-takeaway',
        items: [
