  ...
  return `
    <div style="font-family:Georgia,serif;max-width:560px;margin:0 auto;padding:40px 24px;color:#0a0a0a">
      ...
      <p style="font-size:15px;line-height:1.7;margin:0 0 20px">
        ...
        including how a real 32/34 essay was structured. That's in the full course ($89, one-time).
      </p>
...
function day7Html(email) {
  ...
  return `
    <div style="font-family:Georgia,serif;max-width:560px;margin:0 auto;padding:40px 24px;color:#0a0a0a">
      ...
      <p style="font-size:15px;line-height:1.7;margin:0 0 8px"><strong>What the full course unlocks ($89, one-time):</strong></p>
